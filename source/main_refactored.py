...
class PlanarMonocularSLAM:
    def __init__(self):
        ...
        print(self.projection_associations.shape)
    ...
    def run(self):
        print("===== TRIANGULATION =====")
        XL_guess, Zp, projection_associations, id_landmarks = initialize_landmarks(self.XR_guess, self.Zp, self.projection_associations, self.id_landmarks,
                                                                                   self.camera_transformation, self.invK, self.num_poses, self.num_landmarks)
